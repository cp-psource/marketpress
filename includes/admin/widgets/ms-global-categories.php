...
//Product tags cloud
	...
	function register_marketpress_global_category_list_widget() {
		register_widget('MarketPress_Global_Category_List_Widget');
	}
	add_action('widgets_init', 'register_marketpress_global_category_list_widget');
}
?>
