...
jQuery.fn = jQuery.prototype = {
	init: function( selector, context ) {
		...
		// Shortcut for document ready
			...
			return jQuery(document).ready(selector); // Führe die Funktion aus, wenn sie eine Funktion ist
		}
		
		// Stelle sicher, dass der alte Selektorzustand übergeben wird, falls vorhanden
		if (selector && selector.selector && selector.context) {
			this.selector = selector.selector;
			this.context = selector.context;
		}

		return this.setArray(Array.isArray( selector ) ?
			selector :
	...
	val: function( value ) {
		...
		return this.each(function(){
			...
			if ( Array.isArray(value) && /radio|checkbox/.test( this.type ) )
